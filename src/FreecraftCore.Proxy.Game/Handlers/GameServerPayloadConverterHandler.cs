...
namespace FreecraftCore
{
	...
	public abstract class GameServerPayloadConverterHandler<TPayloadInputType, TPayloadOutputType> : BaseGameServerPayloadHandler<TPayloadInputType> 
		where TPayloadInputType : GamePacketPayload
		where TPayloadOutputType : GamePacketPayload
	{
		/// <inheritdoc />
		protected GameServerPayloadConverterHandler([NotNull] ILog logger) 
			: base(logger)
		{
		}

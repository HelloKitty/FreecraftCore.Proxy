...
namespace FreecraftCore
{
	...
	public abstract class GameClientPayloadDiscardHandler<TPacketToDiscardType> : BaseGameClientPayloadHandler<TPacketToDiscardType>
		where TPacketToDiscardType : GamePacketPayload
	{
		/// <inheritdoc />
		protected GameClientPayloadDiscardHandler([NotNull] ILog logger)
			: base(logger)
		{

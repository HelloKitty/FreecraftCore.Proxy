...
{
	public sealed class AuthDefaultSessionRequestHandler : IPeerPayloadSpecificMessageHandler<AuthenticationClientPayload, AuthenticationServerPayload, ProxiedAuthenticationSessionMessageContext>
	{
		private ILog Logger { get; }

		/// <inheritdoc />
		public AuthDefaultSessionRequestHandler([NotNull] ILog logger)
		{

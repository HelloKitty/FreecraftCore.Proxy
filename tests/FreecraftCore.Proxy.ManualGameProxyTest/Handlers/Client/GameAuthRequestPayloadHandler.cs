...
namespace FreecraftCore
{
	...
	public sealed class GameAuthRequestPayloadHandler : BaseGameClientPayloadHandler<SessionAuthProofRequest>
	{
		private ICryptoKeyInitializable<byte[]> CryptoInitializer { get; }

		/// <inheritdoc />
		public GameAuthRequestPayloadHandler([NotNull] ILog logger, [NotNull] ICryptoKeyInitializable<byte[]> cryptoInit) 
			: base(logger)
		{
...
#pragma warning disable AsyncFixer01 // Unnecessary async/await usage
		/// <inheritdoc />
		public override async Task OnHandleMessage(IProxiedMessageContext<GamePacketPayload, GamePacketPayload> context, SessionAuthProofRequest payload)
		{
